			...
			<table>
                <tr> 
                  ...
                  <?php 
                    ...
                    <? echo "<td class='alt1'><a href=search_cellar.php?PageNo=".($pageNo-1)."&id=".$id."&search=winesbycountry class='nav'>&lt;&lt; Prev..</a>&nbsp;</td>"; ?>
                  ...
                  <?php } 
							...
							for($j=1;$j<=$maxPage;$j++) {
							  ...
							  echo "<a href=search_cellar.php?PageNo=$j&id=".$id."&search=winesbycountry class='nav'>$j</a> ";
							}
							echo "</td>";

						  if ($pageNo < $maxPage)  {
						    echo "<td class='alt1'>";
							echo "<a href=search_cellar.php?PageNo=".($pageNo+1)."&id=".$id."&search=winesbycountry class='nav'>.. Next &gt;&gt;</a>";
							echo "</td>";
						  }
						?>
                </tr>
			...
			<table>
                <tr> 
                  ...
                  <?php 
                    ...
                    <? echo "<td class='alt1'><a href=search_cellar.php?PageNo=".($pageNo-1)."&id=".$id."&search=winesbycolor class='nav'>&lt;&lt; Prev..</a>&nbsp;</td>"; ?>
                  ...
                  <?php } 
							...
							for($j=1;$j<=$maxPage;$j++) {
							  ...
							  echo "<a href=search_cellar.php?PageNo=$j&id=".$id."&search=winesbycolor class='nav'>$j</a> ";
							}
							echo "</td>";

						  if ($pageNo < $maxPage)  {
						    echo "<td class='alt1'>";
							echo "<a href=search_cellar.php?PageNo=".($pageNo+1)."&id=".$id."&search=winesbycolor class='nav'>.. Next &gt;&gt;</a>";
							echo "</td>";
						  }
						?>
                </tr>
			...
			<table>
                <tr> 
				  ...
				  <?php 
                    ...
                    <? 
					echo "<td class='alt1'><a href=search_cellar.php?PageNo=".($pageNo-1)."&id=39&value1=".$value1."&value2=".$value2."&search=winesbyprice class='nav'>&lt;&lt; Prev..</a>&nbsp;</td>"; 
					?>
                  ...
                  <?php } 
							...
							for($j=1;$j<=$maxPage;$j++) {
							  ...
							  echo "<a href=search_cellar.php?PageNo=$j&id=39&value1=".$value1."&value2=".$value2."&search=winesbyprice class='nav'>$j</a> ";
							}
							echo "</td>";

						  if ($pageNo < $maxPage)  {
						    echo "<td class='alt1'>";
							echo "<a href=search_cellar.php?PageNo=".($pageNo+1)."&id=39&value1=".$value1."&value2=".$value2."&search=winesbyprice class='nav'>.. Next &gt;&gt;</a>";
							echo "</td>";
						  }
						?>
