...
<center>
 <form action="./addcustomer.php" name="myform1" method="post" enctype="multipart/form-data">
<TABLE cellSpacing=5 cellPadding=0 width="88%" border=0>
<TBODY>
      <TR> 
        <TD class=formcaption width="20%"> Name<SPAN class=normalText_Red>*</SPAN></TD>
...
<TR>
        <TD height="20" class=formcaption>Comment<SPAN class=normalText_Red></SPAN></TD>
        <TD colSpan=3> 
