...
if ($recordCount>0)
{
	...
	{ if ($row0['Queue']=='0' && $row0['Queue']!='1')
		...
		{
		$javascript_menu_item0.='fx("text='.$row0['EngName'].';show='.$row0['CategoryID'].';url=menudetail.php?id='.$row0['CategoryID'].';fontweight=bold;target=iframe");';
	...
	while($row1 = mysql_fetch_array($rs1))
	{
		...
		{
			$javascript_menu_item1.='fx("text='.$row1['EngName'].' ;show='.$row1['CategoryID'].';url=menudetail.php?id='.$row1['CategoryID'].';target=iframe;width=185");';
			...
			while($row2 = mysql_fetch_array($rs2))
			{
				...
				if (strlen($row2['EngName']) > 20) {
					$javascript_menu_item2.='fx("text='.$row2['EngName'].' ;show='.$row2['CategoryID'].';url=menudetail.php?id='.$row2['CategoryID'].';target=iframe;width=185;height=40;");';
				}
				else
				{
					$javascript_menu_item2.='fx("text='.$row2['EngName'].' ;show='.$row2['CategoryID'].';url=menudetail.php?id='.$row2['CategoryID'].';target=iframe;width=185");';
				}
				//level3
				//sql
						...
						while($row3 = mysql_fetch_array($rs3))
							{
								if($row3['Queue']=='0' && $row3['Queue']!='1')
									...
									{
									$javascript_menu_item3.='fx("text='.$row3['EngName'].' ;show='.$row3['CategoryID'].';url=menudetail.php?id='.$row3['CategoryID'].';target=iframe;width=185");';
				// start level4
		...
		else
		{
			...
			while($row2 = mysql_fetch_array($rs2))
			{
				...
				if (strlen($row2['EngName']) > 20) {
					...
					$javascript_menu_item2.='fx("text='.$row2['EngName'].' ;show='.$row2['CategoryID'].';url=menudetail.php?id='.$row2['CategoryID'].';target=iframe;width=185;height=20;");';
				}
				//level3
				//sql
