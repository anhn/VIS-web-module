...
<table width="97%" height="465" border="0">
   ...
   {
   ?>
			<form name="myform" method="post" action="./vn_advsearch_restaurant.php" enctype="multipart/form-data">
			  <table width="547">
                <tr bgcolor="#990000"> 
...
$country_name1.= '<select name="country"><option value="9_all">All</option>
							'.$country_item1.'
							</select>';
echo $country_name1;
...
$country_name2.= '<select name="color"><option value="9_all">All</option>
							'.$country_item2.'
							</select>';
echo $country_name2;
...
if($skeySearch!="")
{
 ...
 $wh.=" or EngSPec like '%".$skeySearch."%'";
 $msg.=$skeySearch;
}

$SQL="SELECT * FROM Product ";

$SQL .= " WHERE ShowInRestaurant='T' " ;
	 ...
	 <table>
                <tr> 
                  ...
                  <?php 
                    ...
                    <? echo "<td class='alt1'><a href=vn_advsearch_restaurant.php?PageNo=".($pageNo-1)."&id=".$id."&get=get class='nav'>&lt;&lt; Prev..</a>&nbsp;</td>"; ?>
                  ...
                  <?php } 
							...
							for($j=1;$j<=$maxPage;$j++) {
							  ...
							  echo "<a href=vn_advsearch_restaurant.php?PageNo=$j&id=".$id."&get=get class='nav'>$j</a> ";
							}
							echo "</td>";

						  if ($pageNo < $maxPage)  {
						    echo "<td class='alt1'>";
							echo "<a href=vn_advsearch_restaurant.php?PageNo=".($pageNo+1)."&id=".$id."&get=get class='nav'>.. Next &gt;&gt;</a>";
							echo "</td>";
						  }
						?>
