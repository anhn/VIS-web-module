...
//$spaw_default_css_stylesheet = $spaw_root.'wysiwyg.css';
//$spaw_default_css_stylesheet = '/vine/stylesheets/general.css';
...
$spaw_dropdown_data['style']['title'] = 'general-title';
$spaw_dropdown_data['style']['content'] = 'general-body 1';
$spaw_dropdown_data['style']['general-body'] = 'general-body 2';
