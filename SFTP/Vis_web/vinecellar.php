...
echo 'fx("text=Vines By Country;show=VinesByCountry;fontweight=bold;target=iframe");';
echo 'fx("text=Vines By Color;show=VinesByColor;fontweight=bold;target=iframe");';
echo 'fx("text=Vines By Price;show=VinesByPrice;fontweight=bold;target=iframe");';
echo 'fx("text=Advanced Search;url=advsearch.php;fontweight=bold;target=iframe");';
echo'}';
...
{
	$javascript_menu_item1.='fx("text='.$row1['CategoryName'].' ;url=search.php?id='.$row1['CategoryID'].'&search=winesbycountry;target=iframe;width=140");';
}
...
{
	$javascript_menu_item2.='fx("text='.$row2['SubCategoryName'].' ;url=search.php?id='.$row2['SubCategoryID'].'&search=winesbycolor;target=iframe;width=140");';
...
$javascript_menu2.= 'with(new fxmenu("VinesByPrice")){
							...
							width=180;
							height=20;
							fx("text=Under $10 ;url=search.php?id=39&value1=0&value2=10&search=winesbyprice;target=iframe;width=140");
							fx("text=$10 - $15 ;url=search.php?id=39&value1=10&value2=15&search=winesbyprice;target=iframe;width=140");
							fx("text=$15 - $20 ;url=search.php?id=39&value1=15&value2=20&search=winesbyprice;target=iframe;width=140");
							fx("text=$20 - $30 ;url=search.php?id=39&value1=20&value2=30&search=winesbyprice;target=iframe;width=140");
							fx("text=$30 - $50 ;url=search.php?id=39&value1=30&value2=50&search=winesbyprice;target=iframe;width=140");
							fx("text=$50 - $75 ;url=search.php?id=39&value1=50&value2=70&search=winesbyprice;target=iframe;width=140");
							fx("text=$75 - $100 ;url=search.php?id=39&value1=75&value2=100&search=winesbyprice;target=iframe;width=140");
							fx("text=Over $100 ;url=search.php?id=39&value1=100&value2=999999999999&search=winesbyprice;target=iframe;width=140");
