	 ...
	 <table>
                <tr> 
                  ...
                  <?php 
                    ...
                    <? echo "<td class='alt1'><a href=advsearch_process.php?PageNo=".($pageNo-1)."&minPrice=".$minPrice."&maxPrice=".$maxPrice."&keySearch=".$keySearch."&country=".$country."&color=".$color." class='nav'>&lt;&lt; Prev..</a>&nbsp;</td>"; ?>
                  ...
                  <?php } 
							...
							for($j=1;$j<=$maxPage;$j++) {
							  ...
							  echo "<a href=advsearch_process.php?PageNo=$j&minPrice=".$minPrice."&maxPrice=".$maxPrice."&keySearch=".$keySearch."&country=".$country."&color=".$color." class='nav'>$j</a> ";
							}
							echo "</td>";

						  if ($pageNo < $maxPage)  {
						    echo "<td class='alt1'>";
							echo "<a href=advsearch_process.php?PageNo=".($pageNo+1)."&minPrice=".$minPrice."&maxPrice=".$maxPrice."&keySearch=".$keySearch."&country=".$country."&color=".$color." class='nav'>.. Next &gt;&gt;</a>";
							echo "</td>";
						  }
						?>
