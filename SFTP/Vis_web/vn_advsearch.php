...
<BODY id=Body bottomMargin=0 leftMargin=0 topMargin=0 rightMargin=0 MARGINHEIGHT="0" MARGINWIDTH="0" bgColor=#e4e4e4>
	...
	<td>
	<? 
	echo '<a href="vn_menuhome.php?id=0">Home (Vn)</a>&nbsp;&gt;&nbsp;<a href="vn_menudetail.php?id=17">Vine Wine (Vn)</a>&nbsp;&gt;&nbsp;<a href="contact_.php?id=96">Wine list & Buy Online (Vn) </a>';
...
<table width="97%" height="465" border="0">
   ...
   {
   ?>
			<form name="myform" method="post" action="./vn_advsearch.php" enctype="multipart/form-data">
			  <table width="547">
                <tr bgcolor="#990000"> 
	 ...
	 <table>
                <tr> 
                  ...
                  <?php 
                    ...
                    <? echo "<td class='alt1'><a href=vn_advsearch.php?PageNo=".($pageNo-1)."&id=".$id."&get=get class='nav'>&lt;&lt; Prev..</a>&nbsp;</td>"; ?>
                  ...
                  <?php } 
							...
							for($j=1;$j<=$maxPage;$j++) {
							  ...
							  echo "<a href=vn_advsearch.php?PageNo=$j&id=".$id."&get=get class='nav'>$j</a> ";
							}
							echo "</td>";

						  if ($pageNo < $maxPage)  {
						    echo "<td class='alt1'>";
							echo "<a href=vn_advsearch.php?PageNo=".($pageNo+1)."&id=".$id."&get=get class='nav'>.. Next &gt;&gt;</a>";
							echo "</td>";
						  }
						?>
