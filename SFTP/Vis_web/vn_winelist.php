...
<tr>
<?
$SQL3 = "SELECT * FROM Product WHERE WineList = 'T' AND FamilyID = '6' ORDER BY CreateDate DESC Limit 0,6";
...
<tr>
  ...
  <tr> 
    <td height="26"><div align="center"><a href=vn_productdetail.php?id='.$row3["ProdID"].'&type=vine_wine><font color="#660000">More information...</font></a></div></td>
  </tr>
</table>';
