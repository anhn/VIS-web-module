...
<DIV style="FONT-SIZE: 0px; Z-INDEX: -100; LEFT: 0px; VISIBILITY: hidden; WIDTH: 10px; POSITION: absolute; TOP: 0px; HEIGHT: 10px"></DIV>
<FORM id=Form name=Form action=../S-Portal.aspx?tabid=27 method=post encType=multipart/form-data>
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="article_content">
	<tr>
	<td height="25">
			<?
			 if ($id!=0)
...
$SQL3 = "SELECT * FROM menu where PCID=$_GET[id] and ActiveStatus='T' and ShowInIndex='T' order by Position ASC";
