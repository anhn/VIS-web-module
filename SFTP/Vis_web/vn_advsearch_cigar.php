...
<table width="97%" height="465" border="0">
   ...
   {
   ?>
			<form name="myform" method="post" action="./vn_advsearch_cigar.php" enctype="multipart/form-data">
			  <table width="547">
                <tr bgcolor="#990000"> 
	 ...
	 <table>
                <tr> 
                  ...
                  <?php 
                    ...
                    <? echo "<td class='alt1'><a href=vn_advsearch_cigar.php?PageNo=".($pageNo-1)."&id=".$id."&get=get class='nav'>&lt;&lt; Prev..</a>&nbsp;</td>"; ?>
                  ...
                  <?php } 
							...
							for($j=1;$j<=$maxPage;$j++) {
							  ...
							  echo "<a href=vn_advsearch_cigar.php?PageNo=$j&id=".$id."&get=get class='nav'>$j</a> ";
							}
							echo "</td>";

						  if ($pageNo < $maxPage)  {
						    echo "<td class='alt1'>";
							echo "<a href=vn_advsearch_cigar.php?PageNo=".($pageNo+1)."&id=".$id."&get=get class='nav'>.. Next &gt;&gt;</a>";
							echo "</td>";
						  }
						?>
