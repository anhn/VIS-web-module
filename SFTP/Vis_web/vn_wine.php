...
echo 'fx("text=Vines By Country(Vn);show=VinesByCountry;fontweight=bold;target=iframe;height=30");';
echo 'fx("text=Vines By Color(Vn);show=VinesByColor;fontweight=bold;target=iframe;height=30");';
echo 'fx("text=Vines By Price(Vn);show=VinesByPrice;fontweight=bold;target=iframe;height=30");';
echo 'fx("text=Advanced Search(Vn);url=vn_advsearch.php;fontweight=bold;target=iframe;height=30");';
echo'}';
...
{
	$javascript_menu_item1.='fx("text='.$row1['CategoryNameVn'].' ;url=vn_search.php?id='.$row1['CategoryID'].'&search=winesbycountry;target=iframe;width=140");';
}
...
{
	$javascript_menu_item2.='fx("text='.$row2['SubCategoryNameVn'].' ;url=vn_search.php?id='.$row2['SubCategoryID'].'&search=winesbycolor;target=iframe;width=140");';
...
$javascript_menu2.= 'with(new fxmenu("VinesByPrice")){
							...
							width=180;
							height=20;
							fx("text=Under $10 ;url=vn_search.php?id=39&value1=0&value2=10&search=winesbyprice;target=iframe;width=140");
							fx("text=$10 - $15 ;url=vn_search.php?id=39&value1=10&value2=15&search=winesbyprice;target=iframe;width=140");
							fx("text=$15 - $20 ;url=vn_search.php?id=39&value1=15&value2=20&search=winesbyprice;target=iframe;width=140");
							fx("text=$20 - $30 ;url=vn_search.php?id=39&value1=20&value2=30&search=winesbyprice;target=iframe;width=140");
							fx("text=$30 - $50 ;url=vn_search.php?id=39&value1=30&value2=50&search=winesbyprice;target=iframe;width=140");
							fx("text=$50 - $75 ;url=vn_search.php?id=39&value1=50&value2=70&search=winesbyprice;target=iframe;width=140");
							fx("text=$75 - $100 ;url=vn_search.php?id=39&value1=75&value2=100&search=winesbyprice;target=iframe;width=140");
							fx("text=Over $100 ;url=vn_search.php?id=39&value1=100&value2=999999999999&search=winesbyprice;target=iframe;width=140");
