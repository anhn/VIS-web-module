...
<tr>
<?
$SQL3 = "SELECT * FROM Product WHERE VineCellar = 'T' AND FamilyID = '3' or FamilyID = '4' or FamilyID = '5' or FamilyID = '6' or FamilyID = '7' or FamilyID = '8' ORDER BY CreateDate DESC Limit 0,6";
...
<tr>
  ...
  <tr> 
    <td height="26"><div align="center"><a href=productdetail.php?id='.$row3["ProdID"].'&type=vine_cellar><font color="#660000">More information...</font></a></div></td>
  </tr>
</table>';
